...
<html lang="en">
    ...
    <?php } ?>
        ...
        <div class="container-md">
            <form autocomplete="off" action="page2.php" method="get">
                ...
                <div class="mb-3 autocomplete">
                    ...
                    <input type="search" list="datalistOptions" class="form-control" id="program" aria-describedby="programHelp" name="programq" >
                     <datalist id="datalistOptions">
						...
						<option value="Bachelor of Science (Honours Computer Information Systems)">
				...
				<script type = "text/javascript">
					function emptyFields(){
						if(document.getElementById("year").value == ""){
							...
							location.href = "https://roata.myweb.cs.uwindsor.ca/Self-Student%20Counselling/page.php?message=Please+fill+in+all+fields";
                ...
                <!--<button type="submit" href="page2.php" class="btn btn-primary">Continue</button><!--dont use?-->
                <!--<a class="btn btn-primary" href="page2.php" role="button">Continue</a> <!--how to submit form data with link?-->
            </form>
        </div>
